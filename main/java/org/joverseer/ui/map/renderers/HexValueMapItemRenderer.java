...
/**
 * Renders MapItem objects that store hex-value pairs e.g. ArmyRangeMapItem,
 * HexInfoTurnReportMapItem, etc
 * 
...
public class HexValueMapItemRenderer extends DefaultHexRenderer {
	...
	public boolean appliesTo(Object obj) {
		return CharacterRangeMapItem.class.isInstance(obj) || AbstractRangeMapItem.class.isInstance(obj) || HexInfoTurnReportMapItem.class.isInstance(obj);
	}
	...
	private void renderHexInfoTurnReportMapItem(Object obj, Graphics2D g, int x, int y) {
		...
		for (Object hno : hitrmi.getHexes().keySet()) {
			...
			Color c = new Color(bgColor.getRed() - colorDistance, bgColor.getGreen() - colorDistance, bgColor.getBlue() - colorDistance);
