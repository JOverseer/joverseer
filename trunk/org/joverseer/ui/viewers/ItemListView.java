...
import org.joverseer.ui.CustomerTableModel;
...
public class ItemListView extends AbstractView implements ApplicationListener, MouseListener {
    ...
    TurnElementsEnum turnElementType;
    JTable table;
    ...
    private class SelectHexCommandExecutor extends AbstractActionCommandExecutor {
        public void execute() {
            ...
            if (row >= 0) {
                IHasMapLocation selectedItem = (IHasMapLocation)tableModel.getRow(((SortableTableModel)table.getModel()).convertSortedIndexToDataIndex(row));
