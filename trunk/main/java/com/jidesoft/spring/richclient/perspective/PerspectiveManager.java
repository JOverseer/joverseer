...
/**
 * This class is responsible for saving and retreiving the current perspectives
 * including across restarts. Each page uses its own perspective manager.
 * 
 * @author Jonny Wray
 * 
 */
public class PerspectiveManager {
	...
	/**
	 * Returns the current perspective, or the NullPerspective instance if no
