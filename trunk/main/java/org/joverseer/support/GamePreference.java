...
/**
 * Implements a preference that primarily depends on the Game
 * In other words, the system first checks the active game for a value for the preference
 * and then checks the system preferences.
 * 
