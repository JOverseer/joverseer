 ...
 */
public class HexInfo2Viewer extends ObjectViewer {

	public static final String FORM_PAGE = "HexInfo2Viewer"; //$NON-NLS-1$
	...
	public HexInfo2Viewer(FormModel formModel) {
