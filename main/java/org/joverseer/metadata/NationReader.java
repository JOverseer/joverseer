...
public class NationReader implements MetadataReader {
    Object[][] nations_2950 =
            new Object[][]{
                    ...
                    {"Dúnadan Rangers", "DR", new Object[]{SNAEnum.TroopsAt20Training, SNAEnum.BetterMoraleAtNoFood, SNAEnum.FortificationsWithHalfTimber, SNAEnum.MagesAt40, SNAEnum.WarshipsAtStr4}},
                    ...
                    {"Northern Gondor", "NG", new Object[]{SNAEnum.FortificationsWithHalfTimber, SNAEnum.CommandersAt40, SNAEnum.BetterMoraleAtNoFood, SNAEnum.TroopsAt20Training, SNAEnum.WarshipsAtStr4}},
                    {"Southern Gondor", "SG", new Object[]{SNAEnum.FortificationsWithHalfTimber, SNAEnum.MagesAt40, SNAEnum.TroopsAt20Training, SNAEnum.BetterMoraleAtNoFood, SNAEnum.WarshipsAtStr5}},
                    ...
                    {"Noldo Elves", "No", new Object[]{SNAEnum.TroopsAt25Training, SNAEnum.NoMoraleLossOnFM, SNAEnum.UncoverSecretsAt40, SNAEnum.StealthBonus, SNAEnum.WarshipsAtStr5}},
                    {"Witch-king", "WK", new Object[]{SNAEnum.CommandersAt40, SNAEnum.BetterMoraleAtNoFood, SNAEnum.AccessToFrflHrts, SNAEnum.AccessToCjrHds}},
                    {"Dragon Lord", "DL", new Object[]{SNAEnum.StealthBonus, SNAEnum.AccessToTeleport, SNAEnum.ScoutReconAtDouble, SNAEnum.BetterMoraleAtNoFood, SNAEnum.WarshipsAtStr2}},
                    ...
                    {"Cloud Lord", "CL", new Object[]{SNAEnum.KindapAssassAtPlus20, SNAEnum.StealthBonus, SNAEnum.UncoverSecretsAt40, SNAEnum.AgentsAt40}},
                    ...
                    {"Ice King", "IK", new Object[]{SNAEnum.StealthBonus, SNAEnum.AgentsAt40, SNAEnum.AccessToSmnStrms, SNAEnum.BetterMoraleAtNoFood}},
                    {"Quiet Avenger", "QA", new Object[]{SNAEnum.ScoutReconAtDouble, SNAEnum.UncoverSecretsAt40, SNAEnum.EmmisariesAt40, SNAEnum.CommandersAt40, SNAEnum.WarshipsAtStr4}},
                    {"Fire King", "FK", new Object[]{SNAEnum.FreeHire, SNAEnum.ArmiesAt40Morale, SNAEnum.BetterMoraleAtNoFood, SNAEnum.AccessToFntcsm, SNAEnum.AccessToCjrHds}},
                    {"Long Rider", "LR", new Object[]{SNAEnum.CommandersAt40, SNAEnum.AccessToCjrMts, SNAEnum.TroopsAt20Training, SNAEnum.NoMoraleLossOnFM, SNAEnum.WarshipsAtStr4}},
                    ...
                    {"Rhûn Easterlings", "Ea", new Object[]{SNAEnum.CommandersAt40, SNAEnum.ChallengeBonus, SNAEnum.BetterMoraleAtNoFood}},
                    {"Dunlendings", "Du", new Object[]{SNAEnum.ChallengeBonus, SNAEnum.ScoutReconAtDouble, SNAEnum.AgentsAt40}},
                    {"White Wizard", "WW", new Object[]{SNAEnum.FreeHire, SNAEnum.TroopsAt25Training, SNAEnum.CommandersAt40, SNAEnum.ChallengeBonus}},
                    {"Khand Easterlings", "Kh", new Object[]{SNAEnum.CommandersAt40, SNAEnum.ChallengeBonus, SNAEnum.BetterMoraleAtNoFood}},
            };
    ...
    Object[][] nations_BOFA = 
    	new Object[][]{
    		...
    		{"Goblins", "Go", new Object[]{SNAEnum.FreeHire, SNAEnum.TroopsAt20Training, SNAEnum.NoMoraleLossOnFM, SNAEnum.ArmiesAt40Morale}},
    		{"Warg Riders", "Wa", new Object[]{SNAEnum.FreeHire, SNAEnum.NoMoraleLossOnFM, SNAEnum.BetterMoraleAtNoFood}},
    		{"Elves", "El", new Object[]{SNAEnum.FreeHire, SNAEnum.NoMoraleLossOnFM, SNAEnum.TroopsAt25Training}},
    		{"Dwarves", "Dwa", new Object[]{SNAEnum.FreeHire, SNAEnum.ScoutReconAt50, SNAEnum.HIAt30Training, SNAEnum.NoMoraleLossOnFM}},
    		{"Northmen", "Nmen", new Object[]{SNAEnum.FreeHire, SNAEnum.ScoutReconPlus20, SNAEnum.NoMoraleLossOnFM, SNAEnum.BuySellBonus, SNAEnum.FortificationsWithHalfTimber}},
    ...
    Object[][] nations_UW =
        new Object[][]{
                ...
                {"Northmen", "Nm", new Object[]{SNAEnum.ShipsWith750Timber, SNAEnum.BuySellBonus, SNAEnum.TroopsAt20Training, SNAEnum.EmmisariesAt40, SNAEnum.WarshipsAtStr5}},
                {"Riders of Rohan", "RoR", new Object[]{SNAEnum.TroopsAt20Training, SNAEnum.CommandersAt40, SNAEnum.NoMoraleLossOnFM, SNAEnum.AccessToCjrMts}},
                {"Dunadan Rangers", "DR", new Object[]{SNAEnum.TroopsAt20Training, SNAEnum.BetterMoraleAtNoFood, SNAEnum.FortificationsWithHalfTimber, SNAEnum.MagesAt40, SNAEnum.WarshipsAtStr4}},
                {"Silvan Elves", "Sil", new Object[]{SNAEnum.ShipsWith500Timber, SNAEnum.TroopsAt25Training, SNAEnum.StealthBonus, SNAEnum.BetterMoraleAtNoFood, SNAEnum.WarshipsAtStr5}},
                {"Northern Gondor", "NG", new Object[]{SNAEnum.FortificationsWithHalfTimber, SNAEnum.CommandersAt40, SNAEnum.BetterMoraleAtNoFood, SNAEnum.TroopsAt20Training, SNAEnum.WarshipsAtStr4}},
                {"Southern Gondor", "SG", new Object[]{SNAEnum.FortificationsWithHalfTimber, SNAEnum.MagesAt40, SNAEnum.TroopsAt20Training, SNAEnum.BetterMoraleAtNoFood, SNAEnum.WarshipsAtStr5}},
                {"Dwarves", "Dwa", new Object[]{SNAEnum.HIAt30Training, SNAEnum.NoMoraleLossOnFM, SNAEnum.FortificationsWithHalfTimber, SNAEnum.ScoutReconAt50, SNAEnum.WarshipsAtStr2}},
                ...
                {"Dark Lieutenants", "DkL", new Object[]{SNAEnum.CommandersAt40, SNAEnum.AccessToFrflHrts, SNAEnum.AccessToCjrHds, SNAEnum.BetterMoraleAtNoFood}},
                {"Corsairs", "Co", new Object[]{SNAEnum.ShipsWith750Timber, SNAEnum.OpenSeasMvmnt, SNAEnum.ChallengeBonus, SNAEnum.WarshipsAtStr5}},
                {"Rhun Easterlings", "Ea", new Object[]{SNAEnum.CommandersAt40, SNAEnum.ChallengeBonus, SNAEnum.BetterMoraleAtNoFood}},
                {"Dunlendings", "Du", new Object[]{SNAEnum.ChallengeBonus, SNAEnum.ScoutReconAtDouble, SNAEnum.AgentsAt40}},
                {"White Wizard", "WW", new Object[]{SNAEnum.FreeHire, SNAEnum.TroopsAt25Training, SNAEnum.CommandersAt40, SNAEnum.ChallengeBonus}},
                {"Khand Easterlings", "Kh", new Object[]{SNAEnum.CommandersAt40, SNAEnum.ChallengeBonus, SNAEnum.BetterMoraleAtNoFood}},
        };
