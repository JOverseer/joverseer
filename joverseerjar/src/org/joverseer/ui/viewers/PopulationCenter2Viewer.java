 ...
 */
public class PopulationCenter2Viewer extends ObjectViewer {

	public class PopulationCenterModel {
		private final SimpleStringProperty name;
		private final SimpleStringProperty loyalty;
		private final SimpleStringProperty nation;
		private final SimpleStringProperty sizeFort;
		private final SimpleStringProperty lostThisTurn;
		private final SimpleStringProperty productionDescription;
		private final SimpleStringProperty turnInfo;
		
		public PopulationCenterModel()
		{
			loyalty=new SimpleStringProperty();
			nation=new SimpleStringProperty();
			sizeFort=new SimpleStringProperty();
			name=new SimpleStringProperty();
			lostThisTurn=new SimpleStringProperty();
			productionDescription=new SimpleStringProperty();
			turnInfo=new SimpleStringProperty();
		}
		public String getName() { return name.get(); }
		public void setName(String v) { name.set(v); }
		public String getLoyalty() { return loyalty.get(); }
		public void setLoyalty(String v) { loyalty.set(v);}
		public String getNation() { return nation.get(); }
		public void setNation(String v) { nation.set(v); }
		public String getSizeFort() { return sizeFort.get();}
		public void setSizeFort(String v) { sizeFort.set(v); }
		public String getLostThisTurn() { return lostThisTurn.get(); }
		public void setLostThisTurn(String v) { lostThisTurn.set(v); }
		public String getProductionDescription() { return productionDescription.get(); }
		public void setProductionDescription(String v) { productionDescription.set(v); }
		public String getTurnInfo() {return turnInfo.get();}
		public void setTurnInfo(String v) { turnInfo.set(v); }
	...
	public PopulationCenter2Viewer(FormModel formModel) {
