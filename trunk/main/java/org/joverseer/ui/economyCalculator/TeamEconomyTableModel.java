...
public class TeamEconomyTableModel extends BaseEconomyTableModel {
    ...
    String[] columnNames = new String[]{
            "nation", "le", "br", "st", "mi", "fo", "ti", "mo", 
            "surplus", "reserves", "losses",
            "tax rate", "cptl chars", "market", "orders", "final gold"
    };
    
    int[] columnWidths = new int[] {42, 
    ...
    public void setRows(List items) {
        this.items.clear();
        this.items.addAll((Collection<EconomyCalculatorData>)items);
    }
    ...
    public Object getValueAt(int row, int col) {
        ...
        switch (col) {
            case 0:
                ...
                if (n == null) return ecd.getNationNo();
